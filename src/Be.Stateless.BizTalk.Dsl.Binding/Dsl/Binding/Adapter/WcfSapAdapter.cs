...
{
	/// <seealso href="https://docs.microsoft.com/en-us/biztalk/adapters-and-accelerators/adapter-sap/overview-of-the-sap-adapter">Overview of the SAP adapter</seealso>
		...
		new()
	{
		...
		/// <description>
		/// Specifies the behavior the adapter should follow to send a DATS value when the adapter client sends a NULL DateTime
		/// value. You could set this to the following values:
		/// <list type="bullet">
		/// <item>
		/// "ERROR" &#8212; When set to this, the adapter throws an error if the client program sends a NULL DateTime value.
		/// </item>
		/// <item>
		/// "SKIP" &#8212; When set to this, the adapter skips the field and does not send any value to SAP if the client program
		/// sends a NULL DateTime value.
		/// </item>
		/// <item>
		/// &lt;VALUE&gt; &#8212; When set to this, the adapter sends the specified value to SAP if the client program sends a
		/// NULL DateTime value.
		/// </item>
		/// </list>
		/// Default is "SKIP".
		...
		/// Specifies the behavior the adapter should follow to send a TIMS value when the adapter client sends a NULL DateTime
		/// value. You could set this to the following values:
		/// <description>
		/// <list type="bullet">
		/// <item>
		...
		/// <description>
		/// Specifies the behavior the adapter should follow to retrieve a DateTime value when the adapter receives a DATS.MAX
		/// value, which is 99999999, from SAP. You could set this to the following values:
		/// <list type="bullet">
		/// <item>
		...
		/// </item>
		/// <item>
		/// &lt;VALUE&gt; &#8212; When set to this, the adapter parses the specified value in the XSD:DateTime format and returns
		...
		/// <description>
		/// Specifies the behavior the adapter should follow to retrieve a DateTime value when the adapter receives a DATS.MIN
		/// value, which is 00000000, from SAP. You could set this to the following values:
		/// <list type="bullet">
		/// <item>
		...
		/// <description>
		/// Specifies the behavior the adapter should follow to retrieve a DateTime value when the adapter receives an empty DATS
		/// value from SAP. You could set this to the following values:
		/// <list type="bullet">
		/// <item>
		...
		/// <description>
		/// Specifies the behavior the adapter should follow to retrieve an integer value when the adapter receives an empty NUMC
		/// value (all spaces) from SAP. You could set this to the following values:
		/// <list type="bullet">
		/// <item>
		...
		/// </item>
		/// <item>
		/// &lt;VALUE&gt; &#8212; When set to this, the adapter assumes that the specified value is a valid Int32 or Int64 value
		...
		/// <description>
		/// Specifies the behavior the adapter should follow to retrieve a DateTime value when the adapter receives an empty TIMS
		/// value from SAP. You could set this to the following values:
		/// <list type="bullet">
		/// <item>
		...
		/// <description>
		/// Specifies the behavior the adapter should follow to retrieve a DateTime value when the adapter receives an invalid
		/// DATS value from SAP. You could set this to the following values:
		/// <list type="bullet">
		/// <item>
		...
		/// <description>
		/// Specifies the behavior the adapter should follow to retrieve an integer value when the adapter receives an invalid
		/// NUMC value from SAP. You could set this to the following values:
		/// <list type="bullet">
		/// <item>
		...
		/// <description>
		/// Specifies the behavior the adapter should follow to retrieve a DateTime value when the adapter receives a TIMS.MAX
		/// value from SAP. You could set this to the following values:
		/// <list type="bullet">
		/// <item>
		...
		/// <remarks>
		/// <para>
		/// This feature controls how the adapter surfaces certain SAP data types. For more information about safe typing, <see
		/// href="https://docs.microsoft.com/en-us/biztalk/adapters-and-accelerators/adapter-sap/basic-sap-data-types">see Basic
		/// SAP Data Types</see>.
		/// </para>
		/// <para>
		...
		/// <remarks>
		/// <para>
		/// <seealso cref="MaxConnectionsPerSystem"/> is a static property within an application domain. This means that when you
		/// change <seealso cref="MaxConnectionsPerSystem"/> for one binding instance in an application domain, the new value
		...
		/// information about the SAP connection URI, <see
		/// href="https://docs.microsoft.com/en-us/biztalk/adapters-and-accelerators/adapter-sap/create-the-sap-system-connection-uri">Create
		/// the SAP system connection URI</see>.
		/// </remarks>
		...
		/// For more information about the SAP connection URI, <see
		/// href="https://docs.microsoft.com/en-us/biztalk/adapters-and-accelerators/adapter-sap/create-the-sap-system-connection-uri">Create
		/// the SAP system connection URI</see>.
		/// </remarks>
