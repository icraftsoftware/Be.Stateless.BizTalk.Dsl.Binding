...
namespace Be.Stateless.BizTalk.Dsl.Binding.Adapter
{
	...
	public interface IAdapterConfigOutboundAction
	{
		...
		/// property <see cref="WCF.Action"/> in a pipeline or orchestration.
		/// </summary>
		/// <remarks>
		/// <para>
		...
		/// <![CDATA[http://contoso.com/svc/operation1]]>&#8212;the SOAPAction header for outgoing messages is always set to the
		/// value specified in this property.
		/// </para>
		/// <para>
		/// If you set this property in the action mapping format, the outgoing SOAPAction header is determined by the <see
		/// cref="BTS.Operation"/> context property. For example, if this property is set to the following XML format and the
		/// <see cref="BTS.Operation"/> property is set to <c>operation1</c>, the WCF send adapter uses
		...
		/// the <see cref="BTS.Operation"/> property in pipeline components.
		/// </para>
		/// <para>
		...
		/// </term>
		/// <description>
		/// <code><![CDATA[adapter.StaticAction = "http://services.stateless.be/biztalk/factory/mail/1.1/IMailService/SendMessage"; ]]></code>
		/// </description>
		/// </item>
		/// <item>
		/// <term>
