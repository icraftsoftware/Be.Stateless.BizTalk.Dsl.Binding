...
namespace Be.Stateless.BizTalk.Dsl.Binding.Adapter
{
		...
		new()
	{
		...
		{
			_protocolType = GetProtocolTypeFromConfigurationClassId(new("2b219014-ba04-4b70-a66b-a8c418b109fd"));
		}
		...
		/// href="https://docs.microsoft.com/en-us/biztalk/core/technical-reference/wcf-wshttp-transport-properties-dialog-box-receive-security-tab">WCF-WSHttp
		/// Transport Properties Dialog Box, Receive, Security Tab</see> and <see
		/// href="https://docs.microsoft.com/en-us/biztalk/core/technical-reference/wcf-wshttp-transport-properties-dialog-box-send-security-tab">WCF-WSHttp
		...
		/// <remarks>
		/// <para>
		/// If this property is <c>True</c>, the clients are required to submit messages using the WS-AtomicTransaction protocol.
		...
		/// <remarks>
		/// <para>
		/// If the <see cref="MessageClientCredentialType"/> property equals <see cref="MessageCredentialType.None"/>, <see
		/// cref="MessageCredentialType.UserName"/>, or <see cref="MessageCredentialType.Certificate"/>, setting this property to
		/// <c>False</c> implies that the service certificate is available at the client out of band and that the client needs to
		/// specify the service certificate. This mode is interoperable with SOAP stacks that implement WS-Trust and
		/// WS-SecureConversation.
		/// </para>
		/// <para>
		/// If the <see cref="MessageClientCredentialType"/> property is set to <see cref="MessageCredentialType.Windows"/>,
		/// setting this property to <c>False</c> specifies Kerberos-based authentication. This means that the client and service
		...
		/// </para>
		/// <para>
		/// When this property is <c>True</c>, it causes a .NET SOAP negotiation that tunnels SPNego exchange over SOAP messages.
		/// </para>
		/// <para>
