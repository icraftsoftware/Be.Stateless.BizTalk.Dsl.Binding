	...
	public static class BtxServiceTypeExtensions
	{
		...
		internal static Assembly CompileToDynamicAssembly(this Type type)
		{
			using (var provider = new CSharpCodeProvider())
			{
				...
				parameters.ReferencedAssemblies.Add(typeof(BTXService).Assembly.Location);
				// Microsoft.XLANGs.BizTalk.ProcessInterface.dll
				parameters.ReferencedAssemblies.Add(typeof(IOrchestration).Assembly.Location);
				// Microsoft.XLANGs.Engine.dll
				parameters.ReferencedAssemblies.Add(typeof(Service).Assembly.Location);
				// Be.Stateless.BizTalk.Dsl.Abstractions.dll
				parameters.ReferencedAssemblies.Add(typeof(IFluentInterface).Assembly.Location);
