...
namespace Be.Stateless.BizTalk.Dsl.Binding.Adapter
{
	public class WcfWSHttpAdapterFixture
	{
		...
		public void ProtocolTypeSettingsAreReadFromWmiConfigurationClassId()
		{
			...
			nta.ProtocolType.Name.Should().Be("WCF-WSHttp");
			nta.ProtocolType.Capabilities.Should().Be(899);
			nta.ProtocolType.ConfigurationClsid.Should().Be("2b219014-ba04-4b70-a66b-a8c418b109fd");
		}
	}
}
