...
namespace Be.Stateless.BizTalk.Dsl.Environment.Settings.Extensions
{
	public static class AssemblyExtensions
	{
		public static Type GetEnvironmentSettingsType(this Assembly assembly, bool throwOnError = false)
		{
			...
			var types = assembly.GetExportedTypes().Where(t => t.IsEnvironmentSettingsType());
			var type = types.SingleOrDefault();
			return type == null && throwOnError
				? throw new InvalidOperationException(
					$"No {nameof(IEnvironmentSettings)}-derived type was found in assembly '{assembly.FullName}' located at '{assembly.Location}'.")
				: type;
		}
	}
}
