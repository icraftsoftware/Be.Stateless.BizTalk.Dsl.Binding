...
namespace Be.Stateless.BizTalk.Dsl.Binding.Adapter
{
	public abstract partial class HttpAdapter
	{
		...
		/// <seealso href="https://docs.microsoft.com/en-us/biztalk/core/http-receive-adapter">HTTP Receive Adapter</seealso>
		/// <seealso href="https://docs.microsoft.com/en-us/biztalk/core/how-to-configure-an-http-receive-handler">How to Configure an HTTP Receive Handler</seealso>
		/// <seealso href="https://docs.microsoft.com/en-us/biztalk/core/how-to-configure-iis-for-an-http-receive-location">How to Configure IIS for an HTTP Receive Location</seealso>
		/// <seealso href="https://docs.microsoft.com/en-us/biztalk/core/how-to-configure-an-http-receive-location">How to Configure an HTTP Receive Location</seealso>
		public class Inbound : HttpAdapter, IInboundAdapter, IAdapterConfigInboundSuspendRequestMessageOnFailure, IAdapterConfigSSO
		{
			...
			/// <remarks>
			/// <para>
			/// A value of <c>False</c> indicates to discard the failed request and send an error status code (401 or 500) to the
			/// client.
			/// </para>
			/// <para>
			/// A value of <c>True</c> indicates to suspend the failed request and send an "Accepted" status code (202) to the
			...
			{
				propertyBag.WriteAdapterCustomProperty(nameof(LoopBack), LoopBack);
				propertyBag.WriteAdapterCustomProperty(nameof(ResponseContentType), ResponseContentType);
				propertyBag.WriteAdapterCustomProperty(nameof(ReturnCorrelationHandle), ReturnCorrelationHandle);
