...
namespace Be.Stateless.BizTalk.Dsl.Binding.Adapter
{
	...
	public interface IAdapterConfigInboundCredentials
	{
		...
		/// required when the <see cref="CredentialType"/> property is set to <see cref="CredentialSelection.GetCredentials"/>.
		/// </summary>
		/// <remarks>
		...
		/// <list type="bullet">
		/// <item>
		/// <see cref="CredentialSelection.None"/> &#8212; Do not use any credentials when this receive location sends solicit
		/// messages to poll an external service, or this receive location does not need to poll any external service.
		/// </item>
		/// <item>
		/// <see cref="CredentialSelection.IssueTicket"/> &#8212; Use Enterprise Single Sign-On (SSO) to retrieve client
		...
		/// </item>
		/// <item>
		/// <see cref="CredentialSelection.UserAccount"/> &#8212; Use the credentials specified in the <see cref="UserName"/> and
		/// <see cref="Password"/> properties when this receive location sends solicit messages to poll an external service.
		/// </item>
		/// <item>
		/// <see cref="CredentialSelection.GetCredentials"/> &#8212; Use the SSO affiliate application specified in the <see
		/// cref="AffiliateApplicationName"/> property when this receive location sends solicit messages to poll an external
		/// service.
		/// </item>
		/// </list>
		/// </para>
		...
		/// This property is required when the <see cref="CredentialType"/> property is set to <see
