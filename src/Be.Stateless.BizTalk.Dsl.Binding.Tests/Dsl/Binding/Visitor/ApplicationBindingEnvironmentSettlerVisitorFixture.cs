...
{
	public class ApplicationBindingEnvironmentSettlerVisitorFixture : IDisposable
	{
		[Fact]
		public void VisitApplicationBindingAppliesEnvironmentOverrides()
		{
			...
			var visitorMock = new Mock<ApplicationBindingEnvironmentSettlerVisitor> { CallBase = true }
		...
		public ApplicationBindingEnvironmentSettlerVisitorFixture()
		{
