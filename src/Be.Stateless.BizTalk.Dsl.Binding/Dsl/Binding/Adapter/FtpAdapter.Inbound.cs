...
namespace Be.Stateless.BizTalk.Dsl.Binding.Adapter
{
	public abstract partial class FtpAdapter
	{
		...
		/// Host see <see
		/// href="https://docs.microsoft.com/en-us/biztalk/core/considerations-for-running-adapter-handlers-within-a-clustered-host1">Considerations
		/// for Running Adapter Handlers within a Clustered Host</see>.
		/// </para>
		/// </remarks>
		/// <seealso href="https://docs.microsoft.com/en-us/biztalk/core/ftp-adapter">FTP Adapter</seealso>
		/// <seealso href="https://docs.microsoft.com/en-us/biztalk/core/configuring-the-ftp-adapter">Configuring the FTP Adapter</seealso>
		/// <seealso href="https://docs.microsoft.com/en-us/biztalk/core/ftp-adapter-configuration-properties">FTP Adapter Configuration Properties</seealso>
		/// <seealso href="https://docs.microsoft.com/en-us/biztalk/core/best-practices-and-recommendations-for-the-ftp-adapter">Best practices and recommendations for the FTP Adapter</seealso>
		/// <seealso href="https://docs.microsoft.com/en-us/biztalk/core/known-issues-with-the-ftp-adapter">Known Issues with the FTP Adapter</seealso>
		/// <seealso href="https://docs.microsoft.com/en-us/biztalk/core/how-to-diagnose-problems-with-the-ftp-adapter">How to Diagnose Problems with the FTP Adapter</seealso>
...
#pragma warning restore 108
			...
			/// <summary>
			/// Specify how the adapter lists files. To view file names instead of the system-defined file listing, set this value
			/// to <c>true</c>.
			/// </summary>
			[XmlElement("useNLST")]
			...
			/// </para>
			/// <para>
			/// A zero <see cref="TimeSpan"/>, <see cref="TimeSpan.Zero"/>, indicates that the adapter will download the file in
			/// each polling cycle.
			/// </para>
			/// <para>
			...
			{
				get => RedownloadInterval < TimeSpan.Zero
					? -1
					: RedownloadInterval == TimeSpan.Zero
						? 0
...
#pragma warning restore 108
			...
			{
				get => (int) ReceiveTimeout.TotalMilliseconds;
