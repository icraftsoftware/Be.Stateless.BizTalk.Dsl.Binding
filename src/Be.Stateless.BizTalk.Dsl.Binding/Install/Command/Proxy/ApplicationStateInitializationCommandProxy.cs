...
namespace Be.Stateless.BizTalk.Install.Command.Proxy
{
	...
	public class ApplicationStateInitializationCommandProxy : ApplicationBindingBasedCommandProxy
	{
		...
		{
			CommandFactory
				.CreateApplicationStateInitializationCommand(ApplicationBindingType)
