...
namespace Be.Stateless.BizTalk.Dsl.Binding
{
	...
	public interface ISendPortCollection<TNamingConvention> : IFluentInterface, IEnumerable<ISendPort<TNamingConvention>>
		where TNamingConvention : class
	{
		...
		ISendPort<TNamingConvention> Find<T>() where T : ISendPort<TNamingConvention>;
	}
}
