...
namespace Be.Stateless.BizTalk.Dsl.Binding
{
	...
	{
		public DeploymentContextInjectionScope(Type environmentSettingOverridesType = null, string excelSettingOverridesFolderPath = null, string targetEnvironment = null)
		{
