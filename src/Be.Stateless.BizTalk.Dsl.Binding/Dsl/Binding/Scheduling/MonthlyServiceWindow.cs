...
namespace Be.Stateless.BizTalk.Dsl.Binding.Scheduling
{
	...
	public abstract class MonthlyServiceWindow : RecurringServiceWindow
	{
		public bool IsOrdinal => this is OrdinalMonthlyServiceWindow;

		/// <summary>
		/// Months on which the <see cref="MonthlyServiceWindow"/>-derived recurrence will be activated.
		/// </summary>
