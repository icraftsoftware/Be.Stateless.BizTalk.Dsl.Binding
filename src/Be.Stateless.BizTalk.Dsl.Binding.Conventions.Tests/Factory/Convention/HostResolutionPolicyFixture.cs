...
namespace Be.Stateless.BizTalk.Factory.Convention
{
	public class HostResolutionPolicyFixture
	{
		...
		public void ResolveIsolatedHostForHttpAdapter()
		{
			...
			new HostResolutionPolicySpy().ResolveHost(receiveLocationMock.Object.Transport).Should().Be(Platform.Settings.HostNameProvider.IsolatedHost);
		}
		...
		{
			new HostResolutionPolicySpy().ResolveHost(new Mock<IOrchestrationBinding>().Object).Should().Be(Platform.Settings.HostNameProvider.ProcessingHost);
		}
		...
		public void ResolveReceivingHost()
		{
			...
			new HostResolutionPolicySpy().ResolveHost(receiveLocationMock.Object.Transport).Should().Be(Platform.Settings.HostNameProvider.ReceivingHost);
		}
		...
		public void ResolveTransmittingHost()
		{
			...
			new HostResolutionPolicySpy().ResolveHost(sendPortMock.Object.Transport).Should().Be(Platform.Settings.HostNameProvider.TransmittingHost);
		}
