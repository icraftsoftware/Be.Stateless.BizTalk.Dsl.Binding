...
namespace Be.Stateless.BizTalk.Dsl.Binding.Adapter
{
		...
		new()
	{
		...
		/// </item>
		/// <item>
		/// <see cref="Microsoft.BizTalk.Adapter.Wcf.Config.WebHttpSecurityMode.Transport"/>: Security is provided using the
		...
		/// </item>
		/// <item>
		/// <see cref="HttpClientCredentialType.Basic"/>: Basic authentication. In Basic authentication, user names and passwords
		/// are sent in plain text over the network. You must create the domain or local user accounts corresponding to the
		/// credentials.
		/// </item>
		/// <item>
		/// <see cref="HttpClientCredentialType.Digest"/>: Digest authentication. This authentication method operates much like
		...
		/// </item>
		/// <item>
		/// <see cref="HttpClientCredentialType.Ntlm"/>: NTLM authentication. Clients can send the credentials without sending a
		/// password to this receive location. You must create the domain or local user accounts corresponding to client
		/// credentials.
		/// </item>
		/// <item>
		/// <see cref="HttpClientCredentialType.Windows"/>: Windows integrated authentication. Windows Communication Foundation
		...
		/// resembles the following: <code><![CDATA[
		/// <BtsHttpUrlMapping>
		...
		/// scenarios, you must provide the variable component of the URL within curly brackets <c>{</c> <c>}</c>. For example,
		/// in the above snippet, if you specify the customer ID as a variable, it would look like: <code><![CDATA[
		/// <BtsHttpUrlMapping>
		...
		/// </para>
		/// <para>
		/// In such a case, you must also specify where the value for the variable <c>ID</c> must be picked from at runtime. You
