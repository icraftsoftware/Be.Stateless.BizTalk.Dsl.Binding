...
namespace Be.Stateless.BizTalk.Dsl.Binding.Visitor
{
	public class ApplicationBindingVisitorFixture
	{
		...
		public void VisitApplicationBindingAppliesEnvironmentOverridesAndCallsOverridableVisitApplicationBinding()
		{
			...
			var visitor = new Mock<ApplicationBindingVisitor> { CallBase = true };
			visitor.As<IApplicationBindingVisitor>().Object.VisitApplicationBinding(applicationBindingMock.Object);

			applicationBindingMock.As<IVisitable<IApplicationBindingVisitor>>().Verify(a => a.Accept(It.IsAny<EnvironmentOverrideApplicator>()), Times.Once);
