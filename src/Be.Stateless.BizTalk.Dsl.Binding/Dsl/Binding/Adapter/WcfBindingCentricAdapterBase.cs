...
namespace Be.Stateless.BizTalk.Dsl.Binding.Adapter
{
		...
		new()
	{
		...
		/// href="https://docs.microsoft.com/en-us/biztalk/core/specifying-the-message-body-for-the-wcf-adapters">Specifying the
		/// Message Body for the WCF Adapters</see>.
		/// </para>
		/// <para>
		...
		/// the BizTalk message body part. This property is required if the <see cref="InboundBodyLocation"/> property is set to
		/// <see cref="InboundMessageBodySelection.UseBodyPath"/>.
		/// </summary>
		/// <remarks>
		/// <para>
		...
		/// </remarks>
		/// <returns>
		/// The <see cref="TimeSpan"/> that specifies the interval of time to wait for the close method to time out.
		/// </returns>
		...
		/// </remarks>
		/// <returns>
		/// The <see cref="TimeSpan"/> that specifies the interval of time to wait for the open method to time out.
		/// </returns>
		/// <exception cref="ArgumentOutOfRangeException">
		/// The value is less than zero or too large.
		/// </exception>
		...
		/// </remarks>
		/// <returns>
		/// The <see cref="TimeSpan"/> that specifies the interval of time to wait for the send method to time out.
		/// </returns>
		/// <exception cref="ArgumentOutOfRangeException">
		/// The value is less than zero or too large.
		/// </exception>
