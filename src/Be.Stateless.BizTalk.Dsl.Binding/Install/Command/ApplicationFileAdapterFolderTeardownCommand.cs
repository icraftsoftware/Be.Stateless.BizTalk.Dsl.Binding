...
{
	public sealed class ApplicationFileAdapterFolderTeardownCommand<T> : ApplicationBindingBasedCommand<T, ISupplyApplicationFileAdapterFolderTeardownCommandArguments>
