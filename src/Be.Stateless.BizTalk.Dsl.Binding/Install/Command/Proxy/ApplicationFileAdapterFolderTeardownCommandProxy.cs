...
namespace Be.Stateless.BizTalk.Install.Command.Proxy
{
	...
	public class ApplicationFileAdapterFolderTeardownCommandProxy : ApplicationBindingBasedCommandProxy, ISupplyApplicationFileAdapterFolderTeardownCommandArguments
	{
		...
		{
			CommandFactory
				.CreateApplicationFileAdapterFolderTeardownCommand(ApplicationBindingType)
